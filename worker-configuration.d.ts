/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 59d1a477ffd39321553d8ae5d75f0720)
// Runtime types generated with workerd@1.20260907.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	IMAGE_BUCKET: R2Bucket;
	ASSETS: Fetcher;
	APP_ENV: "development" | "production";
	PUBLIC_IMAGE_URL: "http://127.0.0.1:8787/api/local-images" | "https://img.example.com";
	ACCESS_TEAM_DOMAIN: "";
	ACCESS_AUD: "";
}
declare namespace Cloudflare {
	...
	interface DevelopmentEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "development";
		PUBLIC_IMAGE_URL: "http://127.0.0.1:8787/api/local-images";
		ACCESS_TEAM_DOMAIN: "";
		ACCESS_AUD: "";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_IMAGE_URL" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD">> {}
}
